...
| ------------- | --------------- | ------------- | -------------- |
| authority     | 权威，权利，授权        | attachment    | 附件             |
...
| account       | 账户              | agent         | 代理             |
| Authorization | 授权，批准，  授权，证书   | avatar        | 头像             |
...
| Preview     | 预览         | performance  | 表演，执行，性能     |
| perform     | 执行         | Pattern      | 模式           |
