...
本文翻译自 [Android Studio Tips by Philippe Breault](https://github.com/pavlospt/Android-Studio-Tips-by-Philippe-Breault/wiki)，一共收集了62个 Android Studio 使用小技巧和快捷键。 根据这些小技巧的使用场景，本文将这63个小技巧分为常用技巧（1 – 28）、编码技巧（29 – 50）和调试技巧（51 – 63），分成三个部分。
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/07-bookmarks.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/06-codefolding.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/38-comparewithbranch.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/34-comparewithclipboard.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/47-contextinfo.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/08-findaction.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/61-findcompletion.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/42-hideallwindows.gif)
...
- **快捷键：**相关快捷键请在菜单中查看；
- **更多：**如果高亮一个方法的`return`或`throw`语句，将会高亮这个方法的所有出口/结束点；如果高亮某个类定义处的`extend`或`implements`语句，将会高亮继承的或实现的方法；高亮一个`import`语句也会高亮使用到的地方；按下Esc可以退出高亮模式；

![img](http://jaeger.itscoder.com/assets/img/studio_tips/01-highlight.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/41-lasttoolwindow.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/17-navigate-previous-changes.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/02-move_between_methods.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/63-nestednavigation.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/39-navigatetoparent.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/42-openpanelbynumber.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/62-openfinder.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/44-parameterinfo.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/05-quickdefinition.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/49-recentlyedited.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/14-recents.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/50-relatedfile.gif)

#### 22. 返回到编辑器（Return to the Editor）

- **描述：**一大堆快捷键操作会把你从编辑器带走（type hierarchy, find usages, 等等）。如果你想返回到编辑器，你有两个选项：Esc：该操作仅仅把光标移回编辑器。Shift + Esc：该操作会关闭当前面板，然后把光标移回到编辑器。
- **快捷键：**返回但保留打开的面板：Esc关闭面板并返回：Shift + Esc

![img](http://jaeger.itscoder.com/assets/img/studio_tips/40-returntoeditor.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/19-select-in.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/12-expand_shrink_selection.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/32-multiselection.gif)

#### 26. 文件结构弹窗（The File Structure Popup）

- **描述：**该操作可以展示当前类的大纲，并且可以快速跳转。你还可以通过键盘输入来过滤结果。这是一种很高效的方法来跳转到指定方法。
- **更多：**你在输入字符的时候可以用驼峰风格来过滤选项。比如输入”oCr”会找到”onCreate”你可以通过勾选多选框来决定是否显示匿名类。这在某些情况下很有用，比如你想直接跳转到一个OnClickListener的onClick方法。
- **快捷键：**Cmd + F12(OS X)、Ctrl + F12(Windows/Linux)
- **调用：**Menu → Navigate → File Structure

![img](http://jaeger.itscoder.com/assets/img/studio_tips/03-filestructure.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/46-switcher.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/37-vcspopup.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/33-columnselection.gif)

#### 30. 语句补全（Complete Statement）

- **描述：**这个方法将会生成缺失的代码来补全语句，常用的使用场景如下：在行末添加一个分号，即使光标不在行末；为if、while、for 语句生成圆括号和大括号；方法声明后，添加大括号；
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/16-completestatement.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/10-deleteline.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/11-duplicate_lines.gif)

#### 33. 编写正则表达式（Edit Regex）

- **描述：**使用Java编写正则表达式是一件很困难的事，主要原因是：你必须得避开反斜杠；说实话，正则很难；看第二条。

IDE能帮我们干点啥呢？当然是一个舒服的界面来编写和测试正则啦~

- **快捷键：**Alt + Enter → check regexp

![img](http://jaeger.itscoder.com/assets/img/studio_tips/68-checkregexp.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/45-codecompletionentertab.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/53-extractmethod.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/52-extractparam.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/51-extractvariable.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/54-inline.gif)

#### 39. 合并行和文本（Join Lines and Literals）

- **描述：**这个操作比起在行末使劲按删除键爽多了！该操作遵守格式化规则，同时：合并两行注释，同时移除多余的`//`；合并多行字符串，移除`+`和双引号；合并字段的声明和初始化赋值；
- **快捷键：**Ctrl + Shift + J；

![img](http://jaeger.itscoder.com/assets/img/studio_tips/18-joinlines.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/15-live_templates.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/09-movelines.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/15-movemethods.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/58-negatecompletion.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/33-postfixcompletion.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/55-rename.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/69-semicolondotcompletion.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/13-surround_with.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/20-unwrap.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/class_name_completion.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/31-analyzedataflow.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/30-analyzestacktrace.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/26-attachdebugger.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/22-conditionalbreakpoint.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/25-diablebreakpoint.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/27-evaluateexpression.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/28-mouse_evaluate_expression.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/23-loggingbreakpoints.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/29-markobject.gif)﻿
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/36-executionpoint.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/35-stoprocess.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/24-temporarybreakpoints.gif)
...
![img](http://jaeger.itscoder.com/assets/img/studio_tips/04-callinghierarchy.gif)

> 原文链接：http://jaeger.itscoder.com/android/2016/02/14/android-studio-tips.html